...
if __name__ == '__main__':
    ...
    print(f'Given unsorted array:', *elements, sep='\n')
     #: Unpacks the  list, effectively passing each dictionary as a separate argument to the  function.
    #: Specifies that each argument (i.e., each dictionary) should be printed on a new line.
